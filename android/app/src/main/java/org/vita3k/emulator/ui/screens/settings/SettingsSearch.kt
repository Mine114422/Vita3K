...
internal fun rememberSettingsSearchEntries(
    ...
    return remember(context, configuration, isPerApp, isVulkan, showCustomDriverOptions) { buildList {
        ...
        add(entry(SettingsCategory.Controls, R.string.settings_controls_l2r2, R.string.settings_controls_l2r2_desc, scope = SettingsScope.Global, keywords = "touch triggers"))
