...
void SettingsDialog::save_config() {
    ...
    emuenv.cfg.check_for_updates_mode = m_ui->check_for_updates_mode->currentData().toInt();
    emuenv.cfg.check_for_updates = emuenv.cfg.check_for_updates_mode != static_cast<int>(UPDATE_STARTUP_OFF);
