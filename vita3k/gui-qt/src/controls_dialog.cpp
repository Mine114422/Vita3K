...
void ControlsDialog::build_hotkeys_page() {
    ...
    add_row(2, tr("Toggle Touch"), m_hotkeys_page.btn_toggle_touch, m_hotkeys_page.btn_toggle_touch_alt);
    add_row(3, tr("Texture Replace"), m_hotkeys_page.btn_tex_replace, m_hotkeys_page.btn_tex_replace_alt);
    add_row(4, tr("Screenshot"), m_hotkeys_page.btn_screenshot, m_hotkeys_page.btn_screenshot_alt);
